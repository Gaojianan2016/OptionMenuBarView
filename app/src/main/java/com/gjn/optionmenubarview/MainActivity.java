...
public class MainActivity extends AppCompatActivity {
    ...
    private VariableMenuBar variableMenuBar;
    private LinearLayout llMain;
    private VariableMenuBarView vmbv;
    private SingleMenuBarView.OnAdapterListener listener3;
    private VariableMenuBarView.OnItemDateListener listener4;
        ...
        listener3 = new SingleMenuBarView.OnAdapterListener() {
            ...
            public RecyclerView.Adapter onBindItemData(Context context, List<MenuItem> items) {
                return new BaseRecyclerAdapter<MenuItem>(MainActivity.this, R.layout.item, items) {
                    @Override
                    public void bindData(RecyclerViewHolder holder, MenuItem menuItem, int i) {
                        holder.setTextViewText(R.id.tv_item, menuItem.getName() + "111111111");
                    }
                };
            }
        };
